...
struct Gadget TextPad = {
   NULL,   /* next gadget */
   28,46+15,   /* origin XY of hit box relative to window TopLeft */
...
struct Gadget Gadget3 = {
   &TextPad,   /* next gadget */
   28,131+15,   /* origin XY of hit box relative to window TopLeft */
...
struct Gadget Gadget2 = {
   &Gadget3,   /* next gadget */
   224,131+15,   /* origin XY of hit box relative to window TopLeft */
   120,16,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
struct Gadget Gadget1 = {
   &Gadget2,   /* next gadget */
   28,30+15,   /* origin XY of hit box relative to window TopLeft */
...
struct IntuiText IText3 = {
   ...
   (372-(sizeof(RT3DDRAWER)-1)*8)/2,16+10,   /* XY origin relative to container TopLeft */
...
struct IntuiText IText4 = {
   1,2,JAM2,   /* front and back text pens, drawmode and fill byte */
   (372-(sizeof(SSPATH)-1)*8)/2,16+10,   /* XY origin relative to container TopLeft */
   NULL,   /* font pointer or NULL for default */
...
struct NewWindow NewWindowStructure1 = {
   ...
   372,154+15,   /* window width and height */
