...
static struct NewScreen NewScreenStructure = {
   ...
   "Video Backup System Amiga AGA V1.5 © 1993 H. Lyppens Software Productions",   /* screen title */
...
static struct IntuiText IText2 = {
   ...
   80,12,   /* XY origin relative to container TopLeft */
   &TOPAZ60,   /* font pointer or NULL for default */
   "Verify",   /* pointer to text */
...
static struct IntuiText IText1 = {
   ...
   &TOPAZ60,   /* font pointer or NULL for default */
   "File system",   /* pointer to text */
   &IText2   /* next IntuiText structure */
};

static struct Gadget Gadget18 = {
   NULL,   /* next gadget */
   16,120,   /* origin XY of hit box relative to window TopLeft */
   164,21,   /* hit box width and height */
   NULL,   /* gadget flags */
...
static struct Gadget VM_lognamegadget = {
   ...
   211,16,   /* origin XY of hit box relative to window TopLeft */
...
static struct Gadget Gadget16 = {
   ...
   16,195,   /* origin XY of hit box relative to window TopLeft */
   164,14,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget15 = {
   ...
   16,178,   /* origin XY of hit box relative to window TopLeft */
   164,14,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget14 = {
   ...
   16,161,   /* origin XY of hit box relative to window TopLeft */
   164,14,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget VM_logfilegadget = {
   ...
   16,144,   /* origin XY of hit box relative to window TopLeft */
   164,14,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget12 = {
   ...
   16,213,   /* origin XY of hit box relative to window TopLeft */
   164,21,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget11 = {
   ...
   16,94,   /* origin XY of hit box relative to window TopLeft */
   164,21,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget10 = {
   ...
   16,68,   /* origin XY of hit box relative to window TopLeft */
   164,21,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget Gadget9 = {
   ...
   16,42,   /* origin XY of hit box relative to window TopLeft */
   164,21,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget VM_loggadget = {
   &Gadget8,   /* next gadget */
   211,35,   /* origin XY of hit box relative to window TopLeft */
   400,188,   /* hit box width and height */
   GADGHBOX+GADGHIMAGE,   /* gadget flags */
...
static struct Gadget VM_loghoriz = {
   ...
   246,226,   /* origin XY of hit box relative to window TopLeft */
...
static struct Gadget VM_logarrowright = {
   ...
   575,223,   /* origin XY of hit box relative to window TopLeft */
...
static struct Gadget VM_logarrowleft = {
   ...
   210,223,   /* origin XY of hit box relative to window TopLeft */
   36,12,   /* hit box width and height */
   GADGIMAGE,   /* gadget flags */
   RELVERIFY+GADGIMMEDIATE,   /* activation flags */
   BOOLGADGET,   /* gadget type flags */
...
static struct Gadget VM_logarrowdown = {
   ...
   612,208,   /* origin XY of hit box relative to window TopLeft */
...
static struct Image Image5 = {
   0,0,   /* XY origin relative to container TopLeft */
   6,154,   /* Image width and height in pixels */
   0,   /* number of bitplanes in Image */
   NULL,   /* pointer to ImageData */
   0x0000,0x0000,   /* PlanePick and PlaneOnOff */
   NULL   /* next Image structure */
...
static struct Gadget VM_logvert = {
   ...
   14,158,   /* hit box width and height */
   NULL,   /* gadget flags */
   RELVERIFY+GADGIMMEDIATE,   /* activation flags */
   PROPGADGET,   /* gadget type flags */
...
static struct NewWindow NewWindowStructure1 = {
   ...
   640,245,   /* window width and height */
   0,2,   /* detail and block pens */
